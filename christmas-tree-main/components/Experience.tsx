  ...
  return (
    <>
      ...
      <EffectComposer enableNormalPass={false}>
        <Bloom 
    // 当模式为 FOCUS 时，显著降低阈值，让发光效果更梦幻
          luminanceThreshold={mode === TreeMode.FOCUS ? 0.2 : 0.8} 
          mipmapBlur 
          intensity={mode === TreeMode.FOCUS ? 3.0 : 1.5} 
          radius={0.6}
        />
        <Vignette eskil={false} offset={0.1} darkness={mode === TreeMode.FOCUS ? 0.9 : 0.7} />
